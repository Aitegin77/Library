        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnglishName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    ShortName = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    FlagUrl = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    GoogleMapsUrl = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NickName = table.Column<string>(type: "nvarchar(35)", maxLength: 35, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Contacts = table.Column<string>(type: "nvarchar(65)", maxLength: 65, nullable: true),
                    CountryId = table.Column<int>(type: "int", nullable: false),
                    ExtraInfo = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploaderUserId = table.Column<int>(type: "int", nullable: true),
                    UpdatedDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdaterUserId = table.Column<int>(type: "int", nullable: true),
                    DeletedDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleterAdminId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Books_Users_UploaderUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlternativeTitles_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pages", x => new { x.BookId, x.NumberPage });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookmarks_Pages_BookId_NumberPage",
                        columns: x => new { x.BookId, x.NumberPage },
                        principalTable: "Pages",
                        principalColumns: new[] { "BookId", "NumberPage" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlternativeTitles_BookId_Title",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Authors_FirstName_LastName_Patronymic_DateOfBirth",
                table: "Authors",
                columns: new[] { "FirstName", "LastName", "Patronymic", "DateOfBirth" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookmarks_BookId_NumberPage",
                table: "Bookmarks",
                columns: new[] { "BookId", "NumberPage" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Publishers_Name_CountryId",
                table: "Publishers",
